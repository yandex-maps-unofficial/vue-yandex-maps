...
features:
  - icon: 🚀
    title: Легковесная
    details: "У нас всего две зависимости: типы Карт и @nuxt/kit для поддержки Nuxt.<br><br>Проект написан на ES Modules и регистрирует только те компоненты, что вы используете (Tree Shaking).<br><br>Библиотека со всеми типами и файлами весит всего ~120Кб, а вес основного файла **до** минификации - ~50Кб."
  - icon: 🛠️
