...
- Повышена стабильность реактивности маркеров
- ⚠ У Маркера убран проброс data-v-атрибутов, поведение возвращено к тому, как это работало в v2 (из-за необходимости использовать `Fragment`)
- Библиотека теперь собирается на Vite 8
