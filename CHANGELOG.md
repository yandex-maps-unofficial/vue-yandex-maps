...
- Добавлены новые компоненты. В нашу библиотеку мы их также добавили
- В схему добавлен новый параметр: clampMapZoom
- В браузерные ивенты вторым аргументом добавлен mapEvent
- Добавлена куча новых утилит, связанных с компонентом линейки - поддержали более удобный импорт через нашу библиотеку
